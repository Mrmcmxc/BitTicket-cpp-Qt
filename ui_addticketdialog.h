...
public:
    ...
    void setupUi(QDialog *addticketdialog)
    {
        ...
        addticketdialog->resize(777, 607);
        QIcon icon;
        ...
        comboBox = new QComboBox(layoutWidget_8);
        ...
        comboBox_R = new QComboBox(groupBox_3);
        comboBox_R->setObjectName(QString::fromUtf8("comboBox_R"));
        comboBox_R->setGeometry(QRect(110, 30, 191, 22));
