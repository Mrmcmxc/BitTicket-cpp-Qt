...
public:
    ...
    QLabel *lb_display_Channel;
    QLabel *lb_total_solved_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionAdd_Agent = new QAction(MainWindow);
        actionAdd_Agent->setObjectName(QString::fromUtf8("actionAdd_Agent"));
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        groupBox_3 = new QGroupBox(centralwidget);
        groupBox_3->setObjectName(QString::fromUtf8("groupBox_3"));
        groupBox_3->setGeometry(QRect(670, 120, 311, 161));
        QFont font;
        font.setBold(true);
        ...
        lb_display_Channel = new QLabel(groupBox_3);
        lb_display_Channel->setObjectName(QString::fromUtf8("lb_display_Channel"));
        lb_display_Channel->setGeometry(QRect(120, 120, 181, 23));
        lb_display_Channel->setFont(font1);
        lb_display_Channel->setFrameShape(QFrame::Panel);
        lb_display_Channel->setFrameShadow(QFrame::Plain);
        lb_total_solved_2 = new QLabel(groupBox_3);
        lb_total_solved_2->setObjectName(QString::fromUtf8("lb_total_solved_2"));
        lb_total_solved_2->setGeometry(QRect(11, 120, 101, 21));
        lb_total_solved_2->setFont(font1);
        ...
        lblImage->setGeometry(QRect(669, 300, 311, 241));
        ...
        menuFile->addAction(actionAdd_Agent);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionAdd_Agent->setText(QCoreApplication::translate("MainWindow", "Add Agent", nullptr));
        ...
        lb_display_Channel->setText(QString());
        lb_total_solved_2->setText(QCoreApplication::translate("MainWindow", "Channel Used", nullptr));
