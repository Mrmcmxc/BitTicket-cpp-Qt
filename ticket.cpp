...
Ticket::Ticket( QString id, QString incident, QString tag, QString impact, QString urgency,
                ...
                QString name, QString email, QString phone, QString agent,QString status, QString incstatus , QString ImageFilePath, QString channel)
{
    this->id = id;
...
void Ticket::setChannel(QString channel)
{
    this-> channel = channel;
}

QString Ticket::getChannel() const
{
    return channel;
}
